...
//                new History().setLabel("Test01")
//                        .setActiveDate(TestDateUtils.YEAR_2016));
//        orma.insertIntoHistory(
//                new History().setLabel("Test02")
//                        .setActiveDate(TestDateUtils.YEAR_2017));
//        orma.insertIntoHistory(
//                new History().setLabel("Test03")
//                        .setActiveDate(TestDateUtils.YEAR_2100));
//
//        List<History> result = historyRepo.findBetween(
//                TestDateUtils.YEAR_2016, TestDateUtils.YEAR_2017).toList()
//                .toBlocking().single();
//
...
//                        assertThat("1件のHistory追加でrowIdが1(開始値)以外のものが追加された",
//                                rowId, is(1L));
